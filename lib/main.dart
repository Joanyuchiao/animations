  ...
  Widget build(BuildContext context) {
    ...
    var btn = RaisedButton.icon(
      icon: Padding(
        ...
        child: Icon(Icons.swipe_outlined , color: Colors.white),
      ),
      label: Padding(
        padding: EdgeInsets.only(left: 0, top: 10, right: 20, bottom: 10),
        child: Text('移動', style: TextStyle(fontSize: 18, color: Colors.white),),
      ),
  ...
  Widget build(BuildContext context) {
    var w = Expanded(
      child: AnimatedContainer(
        ...
        child: Icon(Icons.swipe_outlined, color: Colors.lightBlue, size: 50),
